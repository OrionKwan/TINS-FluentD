...
ENGINE_ID="${SNMPV3_ENGINE_ID:-0x80001370ac1d2450}"
...
# Create snmptrapd.conf with engine ID from environment
...
echo "SNMPTRAP: $(date '+%Y-%m-%d %H:%M:%S') Trap listener initialized with Engine ID $ENGINE_ID" > /var/log/snmptrapd.log
